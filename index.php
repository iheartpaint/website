...
?>
					...
					$(".color-list").append("<div class='col-md-4 color'><div class='color-square' style='background-color:" + color[0] + "'></div><h3 class='color-name'>" + color[1] + "</h3> <div class='row'><div class='col-md-6'><div class='order btn btn-default'>Order</div></div><div class='col-md-6'><div href='/delete.php/?id=<? echo $array[1]; ?>' class='delete btn btn-default'>Delete</div></div></div></div>");
					</script>
<?php
				}
			}
