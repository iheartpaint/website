...
?>
					...
					$(".color-list").append("<div class='col-md-4 color'><div class='color-square' style='background-color:" + color[0] + "'></div><h3 class='color-name'>" + color[1] + "</h3> <div class='row'><div class='col-md-6'><a href='http://rgb.to/hex/" + color[0] + "'><div class='order btn btn-default'>Find Paint</div></a></div><div class='col-md-6'><a href='/delete.php?id=<? echo $array[0]; ?>'><div class='delete btn btn-default'>Delete</div></a></div></div></div>");
					</script>
<?php
				}
			}
